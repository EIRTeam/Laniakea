	...
	switch (p_what) {
		case NOTIFICATION_READY: {
			...
			for (int i = 0; i < settings->get_scatter_layer_count(); i++) {
				...
				point_layer->set_settings({ .grid_element_count = Vector2i(scatter_layer_settings->get_layer_element_count_per_side(), scatter_layer_settings->get_layer_element_count_per_side()),
