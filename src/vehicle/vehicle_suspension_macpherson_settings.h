...
public:
	...
	SuspensionSolveResult solve(Ref<LNVehicleWheelSettings> p_wheel_settings, Vector3 p_tie_rod_rack_position_world, LNVehicleWheelPosition p_wheel_position, const Node3D *p_vehicle, double p_delta, LNVehicleSuspensionState *p_state) override;
};
