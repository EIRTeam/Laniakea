...
private:
	...
	Ref<ShaderMaterial> debug_overlay_material_nodepth;
	...
	DebugTextLineDrawer *text_line_drawer_physics = nullptr;
	DebugTextLineDrawer *text_line_drawer_process = nullptr;
...
public:
	...
	static void cylinder_with_direction(const Vector3 &p_at, const Vector3 &p_dir, const float p_height, const float p_radius, const Color &p_color, const bool p_depth_test = true, const float p_duration = 0.0f);
	...
	static void filled_arrow(const Vector3 &p_from, const Vector3 &p_to, const float p_width, const Color &p_color, const bool p_depth_test = true, const float p_duration = 0.0f);
	...
	static void circle_with_dir(const Vector3 &p_at, const Vector3 &p_dir, const float p_radius, const Color &p_color, const bool p_depth_test = true, const float p_duration = 0.0f);
...
VARIANT_ENUM_CAST(DebugOverlay::ProcessPass);
